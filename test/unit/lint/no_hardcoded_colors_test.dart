...
void main() {
  ...
  const baseline = <String, int>{
    ...
    'lib/features/settings/ui/sections/prompts_section_vm.dart': 3,
    ...
    'lib/features/workspaces/bloc/workspace_cubit_vm.dart': 10,
    ...
    'lib/features/runs/models/run_config.dart': 5,
  ...
  test('no Colors.white / Colors.black in UI code (ratchet)', () {
    ...
    const colorsBaseline = <String, int>{
      ...
      'lib/features/board/ui/board_view.dart': 0,
      'lib/features/board/ui/sticky_note_chrome.dart': 1,
      'lib/ui/components/menus/miro_toolbar_primitives.dart': 2,
      'lib/features/settings/ui/settings_page.dart': 4,
      'lib/features/settings/ui/sections/about_section_vm.dart': 2,
      'lib/features/settings/ui/sections/prompts_section_vm.dart': 2,
