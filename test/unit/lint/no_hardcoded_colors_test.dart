...
void main() {
  ...
  const baseline = <String, int>{
    ...
    'lib/features/mindmap/mindmap_view.dart': 57,
    ...
    'lib/features/mindmap/nodes/file_tree_node.dart': 32,
    ...
    'lib/features/mindmap/nodes/workspace_node.dart': 19,
    ...
    'lib/features/mindmap/widgets/mindmap_node.dart': 13,
    ...
    'lib/features/mindmap/plugin/example_plugin.dart': 9,
    ...
    'lib/features/mindmap/plugin/mindmap_plugin_registry.dart': 5,
    ...
    'lib/features/mindmap/mindmap_grid.dart': 2,
  ...
  test('no Colors.white / Colors.black in UI code (ratchet)', () {
    ...
    const colorsBaseline = <String, int>{
      ...
      'lib/features/mindmap/mindmap_view.dart': 1,
      'lib/features/mindmap/nodes/workspace_node.dart': 1,
      'lib/features/mindmap/widgets/mindmap_node.dart': 1,
