...
graph LR
  ...
  g_board --> g_board_11["board:icon · bico"]
  g_board --> g_board_12["board:delete"]
  g_board --> g_board_13["board:archive"]
  g_board --> g_board_14["board:unarchive"]
  g_board --> g_board_15["board:focus"]
  g_board --> g_board_16["board:undo · bundo"]
  g_board --> g_board_17["board:redo · bredo"]
  g_board --> g_board_18["board:zoom"]
  g_board --> g_board_19["board:fit"]
  g_board --> g_board_20["board:arrange"]
  g_board --> g_board_21["board:grid"]
  g_board --> g_board_22["select"]
  g_board --> g_board_23["board:use"]
  g_board --> g_board_24["board:current"]
  g_board --> g_board_25["board:translate"]
  g_board --> g_board_26["sticky:create · sticky:new"]
  g_board --> g_board_27["shape:create · shape:new"]
  g_board --> g_board_28["frame:create · frame:new"]
  g_board --> g_board_29["draw:list · drl"]
  g_board --> g_board_30["draw:add · dra"]
  g_board --> g_board_31["draw:remove · drr"]
  g_board --> g_board_32["draw:clear · drc"]
  g_board --> g_board_33["draw:svg · drsvg"]
  g_board --> g_board_34["draw:export · drex"]
  g_board --> g_board_35["draw:file · drf"]
  root --> g_panel(("panel"))
...
- **`board:icon`** *(aliases: bico)* — Set or reset the board icon shown in the boards overview and toolbar. Use "auto" to re-detect from the default folder (e.g. a Flutter app icon), "emoji:<char>" for an emoji, "builtin:<name>" for a bundled preset (yoloit, yoloit_logo, yolo_assistant, copilot, voice), or a path to a PNG/JPG/SVG image file.
  - params: id|name*, icon*
  - example: `yoloit board:icon "My Board" emoji:🚀`
