...
final _uiViewDefaultColors = AppColorScheme.fromAccent(Colors.deepPurple);

/// Declarative JSON UI panel — renders a widget tree without a JS app runtime.
class UiViewPlugin extends BoardPanelPlugin with PanelEditorDialogMixin {
  const UiViewPlugin();

  static const String kTypeId = 'board.ui';

  static Map<String, dynamic> defaultTree() => <String, dynamic>{
    'type': 'column',
    ...
    'children': <Map<String, dynamic>>[
      ...
      <String, dynamic>{
        'type': 'text',
        'data': 'Пустая панель — попросите ассистента нарисовать UI через ui:render',
        'style': <String, dynamic>{
          'fontSize': 12,
          'color': '#94a3b8',
          'textAlign': 'center',
  ...
  @override
  String get displayName => 'UI View';

  @override
  IconData get icon => Icons.view_quilt_outlined;

  @override
  Color get accentColor => _uiViewDefaultColors.primary;

  @override
  Size get defaultSize => const Size(420, 320);
  ...
  @override
  EdgeInsets get contentPadding => const EdgeInsets.all(8);
  ...
  Widget buildContent(
    ...
    final rawTree = treeFromState(panel.state) ?? defaultTree();
...
class _UiViewEditorDialogState extends State<_UiViewEditorDialog> {
  ...
  void initState() {
    super.initState();
    final tree =
        UiViewPlugin.treeFromState(widget.panel.state) ??
        UiViewPlugin.defaultTree();
