...
class _ChatPanelWidgetState extends State<ChatPanelWidget>
  ...
  String _buildAgentMarkdown(String agentId) =>
      buildAgentMarkdown(_subAgents[agentId]);
  ...
  Widget _buildInputBar() {
    ...
    return Container(
      ...
      padding:
          widget.compact
              ? const EdgeInsets.fromLTRB(10, 8, 22, 12)
              : const EdgeInsets.fromLTRB(10, 8, 22, 0),
  ...
  String _injectYoloPanelContext(String text) =>
      injectYoloPanelContext(text, _currentBoardForPanel());
